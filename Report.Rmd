...
![Tree cover Loss in Central European Countries](Images/Screenshot%20from%202024-10-04%2015-07-23.png)
...
**Note**: This section will include some code snippets, the whole code which you can run and play with it, can be found on my Github page in this document.
:::
...
![Moran's I Statistics and p-Values for tree percentage variables from 2018 to 2023](Images/Rplot01.png)
...
![Moran's I Scatterplot showing the scaled values against spatially lagged values for tree percentage in 2018](Images/Rplot05.png)
...
![R-squared Results.](Images/Screenshot from 2024-10-05 00-32-10.png)
...
![Predictor Optimization Results by Region.](Images/Screenshot from 2024-10-05 16-35-17.png)
...
Spatio-temporal analysis is the final stage of this research, where we explore the changes in tree percentage not only across regions but also over time. This approach allows us to understand how tree coverage evolves spatially and temporally, providing insights into patterns of deforestation, reforestation, and land use shifts in different areas. By combining spatial data with temporal trends, we aim to uncover the dynamic relationships between environmental factors and land use practices, helping to identify regions that are undergoing rapid changes and those that remain relatively stable.
